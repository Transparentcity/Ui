...
/** Response shape from GET /api/public/evergreen/cities/{slug}/safety */
export interface EvergreenCitySafetyResponse {
  city: string;
  citySlug: string;
  state: string | null;
  lastUpdated: string;
...
/** Response shape from GET /api/public/evergreen/cities/{slug}/districts/{id}/safety */
export interface EvergreenDistrictSafetyResponse {
  city: string;
  citySlug: string;
  state: string | null;
  district: string;
...
export interface EvergreenCityDistrictItem {
  districtNumber: number;
  districtSlug: string;
  districtName: string;
}

export interface EvergreenCityDistrictsResponse {
  citySlug: string;
  districts: EvergreenCityDistrictItem[];
}

export function getEvergreenCitySafety(
  slug: string
): Promise<EvergreenCitySafetyResponse> {
  return requestPublic<EvergreenCitySafetyResponse>(
    `/api/public/evergreen/cities/${slug}/safety`
  );
}

export function getEvergreenDistrictSafety(
  citySlug: string,
  districtId: number
): Promise<EvergreenDistrictSafetyResponse> {
  return requestPublic<EvergreenDistrictSafetyResponse>(
    `/api/public/evergreen/cities/${citySlug}/districts/${districtId}/safety`
  );
}

export function listEvergreenCityDistricts(
  citySlug: string
): Promise<EvergreenCityDistrictsResponse> {
  return requestPublic<EvergreenCityDistrictsResponse>(
    `/api/public/evergreen/cities/${citySlug}/districts`
  );
}

export interface EvergreenCityListItem {
  city: string;
  citySlug: string;
  state: string | null;
...
export function listEvergreenCities(): Promise<EvergreenCityListItem[]> {
  return requestPublic<EvergreenCityListItem[]>(
    "/api/public/evergreen/cities"
  );
}
