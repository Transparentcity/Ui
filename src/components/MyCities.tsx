            ...
            cities.map((city) => {
              ...
              return (
                <div key={city.id}>
                  ...
                  {/* Section shortcuts: Dashboard, Anomalies */}
                  {onCitySectionClick && (
                    <div className={styles.sectionShortcutList}>
                      <button
                        type="button"
                      ...
                      >
                        <span className={styles.sectionShortcutIcon} aria-hidden>
                          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>
                        </span>
                        <span className={styles.sectionShortcutLabel}>Dashboard</span>
                      </button>
                      <button
                        type="button"
                        className={styles.sectionShortcut}
                      ...
                      >
                        <span className={styles.sectionShortcutIcon} aria-hidden>
                          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"></path><line x1="12" y1="9" x2="12" y2="13"></line><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>
                        </span>
                        <span className={styles.sectionShortcutLabel}>Anomalies</span>
                      </button>
                    </div>
                  )}
                </div>
