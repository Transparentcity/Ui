...
export default function PlaceDashboardStories({
  ...
  if (isLoading) {
    return (
      <div className="dashboard-section place-dashboard-stories">
  ...
  return (
    <div className="dashboard-section place-dashboard-stories" aria-label="Place stories">
      <h2 className="city-view-section-title">{title}</h2>
      <div className="metrics-table-container place-dashboard-stories-list">
